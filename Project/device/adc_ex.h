...
/// ADC event callback
typedef void (*adc_callback_t)(uint32_t event, uint32_t adc_data);
...
extern void adc_init_irq(void);
extern uint32_t adc_channel_read_data(adc_channel_t channel);

//自定义接口
//extern int16_t adc_val_read_by_single_pin(adc_channel_t ch_p, adc_pga_gain_t gain,int sample_num);
//extern int32_t adc_val_read_by_dif_pin(adc_channel_t ch_p, adc_channel_t ch_n, adc_pga_gain_t gain, int sample_num);
//extern void adc_battery_voltage_read_by_dif_pin_unblock(adc_channel_t ch_p, adc_channel_t ch_n, adc_pga_gain_t gain, adc_callback_t cb, int sample_num);
//extern void adc_battery_voltage_read_by_pin_unblock(adc_channel_t ch_p, adc_pga_gain_t gain, adc_callback_t cb, int sample_num);
