...
/// Active Link Used PHY value
enum gap_phy_val
{
    /// LE 1M PHY
    GAP_PHY_VAL_LE_1MBPS      = 0x01,
    /// LE 2M PHY
    GAP_PHY_VAL_LE_2MBPS      = 0x02,
    /// LE Coded PHY
    GAP_PHY_VAL_LE_CODED      = 0x03,
};
...
#if ((CONFIG_DIRECTION_FINDING_CONN_CTE) || (CONFIG_DIRECTION_FINDING_CONNLESS_CTE))
/// I/Q sample
/*@TRACE*/
