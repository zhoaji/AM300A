...
/**
 ****************************************************************************************
 * @brief Get Client support features
 *
 * @param[in] conidx Connection index
 *
 * @return Client support features
 ****************************************************************************************
 */
uint8_t gapc_cli_feat_get(uint8_t conidx);

/**
 ****************************************************************************************
 * @brief Set Client features
 *
 * @param[in] conidx Connection index
 * @param[in] features the client support features value
 *
 ****************************************************************************************
 */
void gapc_cli_feat_set(uint8_t conidx, uint8_t features);
/**
 ****************************************************************************************
 * @brief Get database updated
 *
 * @param[in] conidx Connection index
 *
 ...
 ****************************************************************************************
 */
bool gapc_db_update_get(uint8_t conidx);

/**
 ****************************************************************************************
 * @brief Set database update
 *
 * @param[in] conidx Connection index
 * @param[in] enable True is enabled, False else
 *
 ****************************************************************************************
 */
void gapc_db_update_set(uint8_t conidx, bool enable);

/**
 ****************************************************************************************
 * @brief Get database change aware
 *
 * @param[in] conidx Connection index
 *
 * @return database change aware count
 ****************************************************************************************
 */
uint8_t gapc_db_change_aware_get(uint8_t conidx);

/**
 ****************************************************************************************
 * @brief Set database change aware
 *
 * @param[in] conidx Connection index
 * @param[in] count change aware or change unaware
 *
 ****************************************************************************************
 */
void gapc_db_change_aware_set(uint8_t conidx, uint8_t count);
