...
/* --------------------------   INTERFACES        ----------------------------------------*/
/******************************************************************************************/
extern uint16_t rwip_app_main_task;// add by zhiyuan.chen 20181224 for wvt:gap_epr_p2p_tc_04-10

#if BLE_APP_PRESENT
#define APP_MAIN_TASK       rwip_app_main_task //TASK_APP
#else // BLE_APP_PRESENT
#define APP_MAIN_TASK       rwip_app_main_task //TASK_AHI
