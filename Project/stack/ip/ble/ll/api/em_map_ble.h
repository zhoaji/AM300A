...
#define EM_BLE_CS_NB              (BLE_ACTIVITY_MAX_BC + BLE_OBSERVER_BC + BLE_CENTRAL_BC)
...
#define EM_BLE_WL_NB             (BLE_WHITELIST_MAX)
#define EM_BLE_WL_SIZE           (EM_BLE_WL_NB * REG_EM_BLE_WL_SIZE)
...
#define EM_BLE_RAL_NB            (BLE_RESOL_ADDR_LIST_MAX)
#define EM_BLE_RAL_SIZE          (EM_BLE_RAL_NB * REG_EM_BLE_RAL_SIZE)
...
#define EM_BLE_LLCPTXBUF_NB        (2*BLE_ACTIVITY_MAX_BC)
...
#define EM_BLE_ADVEXTHDRTXBUF_NB        (BLE_ADV_BUF_NB_TX)
...
#define EM_BLE_ADVDATATXBUF_NB_MAX    (BLE_ADV_BUF_NB_TX_MAX)
...
#define EM_BLE_DATARXBUF_NB_MAX    (BLE_DATA_BUF_NB_RX_MAX)
#define EM_BLE_DATARXBUF_SIZE      (sc.em.datarxbuf_size)
#define EM_BLE_DATARXBUF_SIZE_MAX  (256)
...
#define EM_BLE_ACLTXBUF_NB_MAX    (BLE_ACL_BUF_NB_TX_MAX)
#define EM_BLE_ACLTXBUF_SIZE      (sc.em.acltxbuf_size)
#define EM_BLE_ACLTXBUF_SIZE_MAX  (256)
