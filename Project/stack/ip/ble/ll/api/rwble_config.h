...
/// Features byte 2
#if (CONFIG_BLE_VERSION >= BLE_VERSION_51)
#define BLE_FEATURES_BYTE2  (  (1                             << (MIN_NUM_USED_CHAN_PROC     - 16) ) \
                             | (BLE_CONN_CTE_REQ_SUPPORT      << (BLE_CONN_CTE_REQ           - 16) ) \
                             | (BLE_CONN_CTE_RSP_SUPPORT      << (BLE_CONN_CTE_RSP           - 16) ) \
                             | (BLE_CONNLESS_CTE_TX_SUPPORT   << (BLE_CONNLESS_CTE_TX        - 16) ) \
                             | (BLE_CONNLESS_CTE_RX_SUPPORT   << (BLE_CONNLESS_CTE_RX        - 16) ) \
                             | (BLE_ANT_SW_DUR_CTE_TX_SUPPORT << (BLE_ANT_SWITCH_DUR_CTE_TX  - 16) ) \
                             | (BLE_ANT_SW_DUR_CTE_RX_SUPPORT << (BLE_ANT_SWITCH_DUR_CTE_RX  - 16) ) \
                             | (BLE_RCV_CTE_SUPPORT           << (BLE_RCV_CTE                - 16) ) )
#else
#define BLE_FEATURES_BYTE2  (  (1 << (MIN_NUM_USED_CHAN_PROC - 16) ) )
#endif  // (CONFIG_BLE_VERSION >= BLE_VERSION_51)

/// Features byte 3
#if (CONFIG_PER_ADV_SYNC_TRANSFER)
#define BLE_FEATURES_BYTE3  (  (1                             << (BLE_PER_ADV_SYNC_TRANS_SND - 24) ) \
                             | (1                             << (BLE_PER_ADV_SYNC_TRANS_RCP - 24) ) \
                             | (0                             << (BLE_SLP_CLK_ACC_UPDATE     - 24) ) \
                             | (1                             << (BLE_FEAT_PUB_KEY_VALID     - 24) ) )
#else
#define BLE_FEATURES_BYTE3  (  (0                             << (BLE_SLP_CLK_ACC_UPDATE     - 24) ) \
                             | (1                             << (BLE_FEAT_PUB_KEY_VALID     - 24) ) )
...
#define BLE_WHITELIST_MAX           (BLE_ACTIVITY_MAX_BC + 2)
...
#define BLE_DATA_BUF_NB_RX_MAX       (BLE_RX_DESC_NB + 3)
#define BLE_DATA_BUF_NB_RX           (sc.em.datarxbuf_nb)
...
#define BLE_ACL_BUF_NB_TX_MAX        (BLE_ACTIVITY_MAX_BC + 2)
#define BLE_ACL_BUF_NB_TX            (sc.em.acltxbuf_nb)

/// Number of advertising data buffers
#define BLE_ADV_BUF_NB_TX_MAX        (BLE_ACTIVITY_MAX_BC)
#define BLE_ADV_BUF_NB_TX            (sc.em.advdatatxbuf_nb)
/// Number of advertising or scan response data fragments in extended advertising PDU chain
#define BLE_ADV_FRAG_NB_TX_MAX       (5)
#define BLE_ADV_FRAG_NB_TX           (sc.em.advdatatxbuf_frag_nb)
/// Size of advertising or scan response data fragments in extended advertising PDU chain
#define BLE_ADV_FRAG_SIZE_TX_MAX     (254)
#define BLE_ADV_FRAG_SIZE_TX         (sc.em.advdatatxbuf_frag_size)
...
//#if (BLE_NB_TX_DESC_PER_CON > BLE_NB_TX_DESC_PER_ADV) liq-
...
#define BLE_TX_DESC_NB               (BLE_NB_TX_DESC_PER_ACT * BLE_ACTIVITY_MAX_BC)
...
#define BLE_EVT_MASK                {0xFD, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00}
