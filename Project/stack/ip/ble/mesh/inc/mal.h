...
#include "mesh_api.h"          // Mesh Stack API defines
...
#if 0 //FIXME Prevent Redefinition warnning in KEIL AC6
 ...
 ****************************************************************************************
 */
void mal_sec_pub_key_read(bool renew, mal_sec_pub_key_res_cb res_cb);
