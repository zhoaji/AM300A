...
/**
 ****************************************************************************************
 * @brief Get model local index by model identified.
 *
 * @param[in] model_id          Model identifier.
 *
 * @return Model local index.
 ****************************************************************************************
 */
m_lid_t m_tb_mio_get_model_lid(uint32_t model_id);
 ...
 ****************************************************************************************
 */
void m_tb_mio_get_nb_models(uint8_t addr_offset, uint8_t *p_nb_sig_models, uint8_t *p_nb_vendor_models);
 ...
 ****************************************************************************************
 */
void m_tb_mio_get_model_ids(uint8_t addr_offset, uint8_t *p_data, bool vendor);
