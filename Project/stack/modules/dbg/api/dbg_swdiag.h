...
#define DBG_SWDIAG(bank , field , value) \
    if(dbg_swdiag_callback){dbg_swdiag_callback(DBG_SWDIAG_##bank, DBG_SWDIAG_##bank##_##field##_OFFSET, value);}

#define DBG_SWDIAG_EX(bank , field) \
    if(dbg_swdiag_callback){dbg_swdiag_callback(bank, field, 1);}

#define DBG_SWDIAG_PIN(pin)             ((pin) & 0x3F)
#define DBG_SWDIAG_PIN_REVERSE(pin)     ((pin) | 0x80)
#define DBG_SWDIAG_PIN_NOREVERSE(pin)   ((pin) & 0x3F)
#define DBG_SWDIAG_PIN_IS_REVERSED(pin) ((pin) & 0x80)
...
typedef void (* dbg_swdiag_callback_t)(uint8_t bank, uint8_t field, uint8_t value);

enum dbg_swdiag_ex_field
{
    DBG_SWDIAG_EVT_BEGIN = 1,
    DBG_SWDIAG_EVT_END   = 0,
};
...
enum dbg_swdiag
{
	...
	*/
     ...
     ******************************************************************************************
     */
    DBG_SWDIAG_POWER_CPU_GATE                           = 48,
    DBG_SWDIAG_POWER_SLEEP                              = 49,
    DBG_SWDIAG_POWER_DEEP_SLEEP                         = 50,
    DBG_SWDIAG_POWER_RW_SLEEP                           = 51,

    /**
     ******************************************************************************************
     * @brief BANK 48 : LE CONNECTION with linkid
     ******************************************************************************************
     */
    DBG_SWDIAG_LECON_LINKID                             = 52,
    DBG_SWDIAG_LECON_LINKID_END                         = DBG_SWDIAG_LECON_LINKID+BLE_ACTIVITY_MAX,

    /// Number of SW profiles - to increase when new bank are added
    DBG_SWDIAG_NB_PROFILES                              = DBG_SWDIAG_LECON_LINKID_END,
};
...
/// swdiag
extern dbg_swdiag_callback_t dbg_swdiag_callback;
 ...
 * @return None
 **/
void dbg_swdiag_set(uint8_t bank, uint8_t pin);
