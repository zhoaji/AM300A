...
/**
 ****************************************************************************************
 * @brief Schedule all pending events for RTOS.
 ****************************************************************************************
 */
void rwip_schedule_rtos(void);

/**
 * @brief  rwip bb frame ongoing
 *
 * @param[in] ongoing  ongoing
 **/
void rwip_bb_frame_ongoing(bool ongoing);
