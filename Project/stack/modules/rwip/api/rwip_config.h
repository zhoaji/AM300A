...
#if defined(CFG_APP) && !defined(CONFIG_SDK_LIB)
...
#define CONFIG_SLV_LATENCY_IGNORE
#define CONFIG_LOCAL_DRIFT_DYNAMIC
#define CONFIG_ACTIVITY_MAX_EM_DYNAMIC
#define CONFIG_WHITELIST_MAX    6

#if defined(CONFIG_HS6621C) && (CONFIG_HARDWARE_VERSION==1) && defined(CONFIG_SDK_LIB)
// HS6621C A1 ROM not support this feature
#undef CONFIG_SLV_LATENCY_IGNORE
#undef CONFIG_LOCAL_DRIFT_DYNAMIC
#undef CONFIG_ACTIVITY_MAX_EM_DYNAMIC
#undef CONFIG_WHITELIST_MAX
#endif

#ifdef CONFIG_USE_BASE_COMPONENT_SYMBOL
#if (defined(CONFIG_RW_OBSERVER) || defined(CONFIG_RW_CENTRAL) || defined(CONFIG_RW_ALLROLES))
#define EM_BLE_OBSERVER     1
#else
#define EM_BLE_OBSERVER     0
#endif
#if (defined(CONFIG_RW_CENTRAL) || defined(CONFIG_RW_ALLROLES))
#define EM_BLE_CENTRAL      1
#else
#define EM_BLE_CENTRAL      0
#endif
#define EM_BLE_ACTIVITY_MAX CONFIG_RW_ACT
#else
#define EM_BLE_OBSERVER     BLE_OBSERVER
#define EM_BLE_CENTRAL      BLE_CENTRAL
#define EM_BLE_ACTIVITY_MAX CFG_ACT
#endif

#ifdef CONFIG_ACTIVITY_MAX_EM_DYNAMIC
#undef EM_BLE_ACTIVITY_MAX
#define EM_BLE_ACTIVITY_MAX sc.em.activity_max
#endif
...
// PING feature
#ifdef CONFIG_LE_PING
#define BLE_LE_PING_SUPPORT                         1
#else
#define BLE_LE_PING_SUPPORT                         0
#endif

//Direction Finding feature
#if (CONFIG_DIRECTION_FINDING_CONN_CTE)
#define BLE_CONN_CTE_REQ_SUPPORT                    1
#define BLE_CONN_CTE_RSP_SUPPORT                    1
#define BLE_RCV_CTE_SUPPORT                         1
#else
#define BLE_CONN_CTE_REQ_SUPPORT                    0
#define BLE_CONN_CTE_RSP_SUPPORT                    0
#define BLE_RCV_CTE_SUPPORT                         0
#endif  //(CONFIG_DIRECTION_FINDING_CONN_CTE)
#if (CONFIG_DIRECTION_FINDING_CONNLESS_CTE)
#define BLE_CONNLESS_CTE_TX_SUPPORT                 1
#define BLE_CONNLESS_CTE_RX_SUPPORT                 1
#else
#define BLE_CONNLESS_CTE_TX_SUPPORT                 0
#define BLE_CONNLESS_CTE_RX_SUPPORT                 0
#endif  //(CONFIG_DIRECTION_FINDING_CONNLESS_CTE)
#if (CONFIG_DIRECTION_FINDING)
#define BLE_ANT_SW_DUR_CTE_TX_SUPPORT               1
#define BLE_ANT_SW_DUR_CTE_RX_SUPPORT               1
#else
#define BLE_ANT_SW_DUR_CTE_TX_SUPPORT               0
#define BLE_ANT_SW_DUR_CTE_RX_SUPPORT               0
...
/// Flag indication if NVDS feature is supported new one or old
#if defined(CFG_NVDS)
    #define NVDS_SUPPORT                    1
    #if CFG_NVDS_NEW
        #define NVDS_EN_NEW                 1
    #else
        #define NVDS_EN_NEW                 0
    #endif
#else // CFG_NVDS
...
//    #endif // SECURE_CONNECTIONS
    ...
    KE_EVENT_CO_TIMER,          //!< KE_EVENT_CO_TIMER
    ...
    // connect slave latency backoff
    KE_EVENT_CON_SLAVE_LATENCY_BACKOFF,

    // bb fram ongoing
    KE_EVENT_BB_FRAME_ONGOING,

    // Reserve for user
    KE_EVENT_USR_FIRST,
    KE_EVENT_USR_LAST = 30,

    // Mesh
    KE_EVENT_BLE_MESH_DJOB = 31,
...
enum KE_TASK_TYPE
{
    ...
    /// Reserve for user
    TASK_USR_FIRST,
    TASK_USR_LAST = TASK_USR_FIRST + 10,
...
#define ECC_HEAP_NON_RET_SIZE_   (328*10) // Could only have 2 ECC computations simultaneously
...
enum PARAM_ID
{
    ...
    /// Static Address
    PARAM_ID_STATIC_ADDRESS             = 0x42,
    PARAM_ID_OTAS_STATIC_ADDRESS        = 0x43,
