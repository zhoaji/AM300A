...
enum TASK_API_ID
{
    ...
    TASK_ID_WECHAT,              // Wechat Server Task

    TASK_ID_ANCSC,               // Apple Notification Center Server(ANCS) Task

    TASK_ID_OTAS,

    TASK_ID_TSPPS            ,   // transport server Task
    TASK_ID_TSPPC            ,   // transport cliet Task
    TASK_ID_SIMPLE_SERVER,       // Simple Server Task

    TASK_ID_ATVVS            ,   // ATV Voice Task
    
    TASK_ID_USER,                // User Custom Task
